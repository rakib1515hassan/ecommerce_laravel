...
class SslCommerzPayment extends AbstractSslCommerz
{
    protected $data = [];
    protected $config = [];
...
//                    }
    ...
    {
        $this->successUrl = route('sslcommerz.success');
    }
    ...
    {
        $this->failedUrl = route('sslcommerz.failed');
    }
    ...
    {
        $this->cancelUrl = route('sslcommerz.cancel');
    }
    ...
    {
        $this->ipnUrl = route('sslcommerz.ipn');
    }
