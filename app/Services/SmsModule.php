...
class SmsModule
{
    ...
    public static function sendSms_greenweb($user, $msg)
    {
        // Log::info('Welcome To SMS Modules :: Greenweb');
        // Log::info('User Name: ' . $user->fullname);
        ...
        if ($url && $token && $msg) {
            try {
                ...
                $phone = $user->phone;
                $lastTenDigits = substr($phone, -10);
                $to = "+880" . $lastTenDigits;
