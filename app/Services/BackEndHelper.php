...
class BackEndHelper
{
    ...
    public static function usd_to_currency($amount)
    {
        ...
        if ($currency_model == 'multi_currency') {
            ...
            if (session()->has('default')) {
                ...
                $default = Currency::find(AdditionalServices::get_business_settings('system_default_currency'))->exchange_rate;
    ...
    {
        $currency = Currency::where('id', AdditionalServices::get_business_settings('system_default_currency'))->first();
