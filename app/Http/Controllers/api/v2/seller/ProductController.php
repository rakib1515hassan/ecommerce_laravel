...
class ProductController extends Controller
{
    ...
    public function stock_out_list(Request $request)
    {
        ...
        $products->map(function ($data) {
            $data = AdditionalServices::product_data_formatting($data);
            return $data;
        });
    ...
    public function add_new(Request $request)
    {
        ...
        $product->name = $request->name[array_search(AdditionalServices::default_lang(), $request->lang)];
        $product->slug = Str::slug($request->name[array_search(AdditionalServices::default_lang(), $request->lang)], '-') . '-' . Str::random(6);
        ...
        $product->details = $request->description[array_search(AdditionalServices::default_lang(), $request->lang)];
        ...
        foreach ($request->lang as $index => $key) {
            if ($request->name[$index] && $key != AdditionalServices::default_lang()) {
            ...
            if ($request->description[$index] && $key != AdditionalServices::default_lang()) {
                array_push($data, array(
                    'translationable_type' => 'App\Models\Product',
                    'translationable_id' => $product->id,
                    'locale' => $key,
    ...
    public function edit(Request $request, $id)
    {
        ...
        $product = AdditionalServices::product_data_formatting($product);
