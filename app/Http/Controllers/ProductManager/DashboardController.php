...
class DashboardController extends Controller
{
    ...
    // {
    //     return view('product_manager-views.system.dashboard');
    // }
    public function dashboard()
    {
        ...
        $product_manager_earnings = OrderTransaction::where([
            'seller_is' => 'seller',
        ...
        for ($inc = 1; $inc <= 12; $inc++) {
            $product_manager_data[$inc] = 0;
            foreach ($product_manager_earnings as $match) {
                if ($match['month'] == $inc) {
                    $product_manager_data[$inc] = $match['sums'];
                }
            }
        }
        ...
        $admin_wallet = ProductManagerWallet::where('product_manager_id', auth('product_manager')->id())->first();
        ...
        return view('product_manager-views.system.dashboard', compact('data', 'product_manager_data', 'commission_data'));
    }
    ...
    public function order_stats(Request $request)
    {
        ...
        return response()->json([
            'view' => view('product_manager-views.partials._dashboard-order-stats', compact('data'))->render()
        ], 200);
    }
