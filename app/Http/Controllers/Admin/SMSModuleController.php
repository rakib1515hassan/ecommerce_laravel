...
class SMSModuleController extends Controller
{
    ...
    public function sms_update(Request $request, $module)
    {
        ...
        if ($request['status'] == 1) {
            $config = AdditionalServices::get_business_settings('twilio_sms');
            ...
            $config = AdditionalServices::get_business_settings('nexmo_sms');
            ...
            $config = AdditionalServices::get_business_settings('2factor_sms');
            ...
            $config = AdditionalServices::get_business_settings('msg91_sms');
            ...
            $config = AdditionalServices::get_business_settings('releans_sms');
