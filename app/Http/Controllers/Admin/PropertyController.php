...
class PropertyController extends Controller
{
    public function add_new_property()
    {
        ...
        $categories = ServiceCategory::where('category_type', 'property')->get();
        return view('admin-views.property.add-new-property', compact('categories'));
    }
    ...
    public function show_update_page(Request $request, $id)
    {
        ...
        return view('admin-views.property.edit-property', compact('service', 'categories'));
    }
    ...
    public function list(Request $request)
    {
        ...
        $services = Service::query()
            ->whereHas('category', function ($query) {
                $query->where('category_type', 'property');
            });
        ...
        return view('admin-views.property.property-list', compact('services', 'search'));
    }
    ...
    public function delete($id)
    {
        ...
        Toastr::success("Property and its related images deleted successfully!", "Success");
