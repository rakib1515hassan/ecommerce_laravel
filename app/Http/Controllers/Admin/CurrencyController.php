...
class CurrencyController extends Controller
{
    public function index(Request $request)
    {
        ...
        $currencies = $currencies->paginate(AdditionalServices::pagination_limit())->appends($query_param);
