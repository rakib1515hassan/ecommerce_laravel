...
class ProductController extends Controller
{
    public function add_new()
    {
        ...
        $product_managers = ProductManager::where(['seller_id' => auth('seller')->id()])->get();

        $seller = auth('seller')->user();

        return view('seller-views.product.add-new', compact('cat', 'br', 'product_managers', 'seller'));
    }

    public function status_update(Request $request)
    {
        if ($request->has('product_manager_status')) {
            Product::where(['id' => $request['id'], 'added_by' => 'seller', 'user_id' => \auth('seller')->id()])->update([
                'product_manager_status' => $request['status'],
            ]);
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'policy' => 'required',
            'seller_amount' => 'required|numeric|min:0',
            'reseller_amount' => 'required|numeric|min:0',
        ], [
        ...
        $product->is_admin_manage = $request->has('is_admin_manage') ? 1 : 0;
    ...
    public function edit($id)
    {
        ...
        return view('seller-views.product.edit', compact('categories', 'br', 'product', 'product_category', 'product_managers', 'seller'));
