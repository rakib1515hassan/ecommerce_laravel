...
class DealController extends Controller
{
    public function flash_index(Request $request)
    {
        ...
        $flash_deal = $flash_deal->where('status', 1)->latest()->paginate(AdditionalServices::pagination_limit())->appends($query_param);
    ...
    public function add_product($deal_id)
    {
        ...
        return view('seller-views.deal.add-product', compact('deal', 'flash_deal_products'));
    }
    ...
    public function add_product_submit(Request $request, $deal_id)
    {
        ...
        $flash_deal_product = FlashDealProduct::where('flash_deal_id', $deal_id)
    ...
    public function deal_of_day(Request $request)
    {
        ...
        return view('seller-views.deal.day-index', compact('deals', 'search'));
    }
    ...
    public function day_update(Request $request, $deal_id)
    {
        ...
        Toastr::success('Deal updated successfully!');
        return redirect()->route('seller.deal.day');
    }
