...
@push('css_or_js')
    @if($shop['id'] != 0)
        <meta property="og:image" content="{{asset('storage/order')}}/{{$shop->image}}"/>
    ...
    @if($shop['id'] != 0)
        <meta property="twitter:card" content="{{asset('storage/order')}}/{{$shop->image}}"/>
            ...
            <div class="col-lg-12 mt-2">
                <div style="background: white">
                    ...
                    @else
                        ...
                        <img style="width:100%; height: auto; max-height: 13.75rem; border-radius: 3px;"
                             src="{{asset("storage/order")}}/{{$banner??""}}"
                             onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                             alt="">
                    @endif
                </div>
            ...
            <div class="col-md-3 mt-2 rtl"
                ...
                <a class="openbtn-tab" style="" onclick="openNav()">
                    <div
                        ...
                        class="for-tab-display"> ☰ {{translate('categories')}}</div>
                </a>
            </div>
            {{-- seller info+contact --}}
            <div class="col-lg-12 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                <div class="mt-4 mb-2">
                    <div class="row" style="margin-left: 2px">
                        ...
                        <div class="row col-lg-8 col-md-6 col-12" style="margin-bottom: 10px">
                            <div class="element-center">
                                @if($shop['id'] != 0)
                                    <img style="height: 65px; border-radius: 2px;"
                                         src="{{asset('storage/order')}}/{{$shop->image}}"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         alt="">
                                @else
                                    <img style="height: 65px; border-radius: 2px;"
                            ...
                            <div class="row col-8 mx-1" style="display:inline-block;">
                                ...
                                <div class="row ml-4 flex-start">
                                    ...
                                    <div>{{ $total_review}} {{translate('reviews')}}
                                        / {{ $total_order}} {{translate('orders')}}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{--                                            {{translate('Contact')}} {{translate('Seller')}}--}}
                        {{--                                        </button>--}}
                        {{--                                    </div>--}}
                        {{--                                @else--}}
                        {{--                                    <div class="d-flex">--}}
                        ...
                        {{-- search --}}
                        <div class="col-lg-2 col-md-3 col-sm-12 col-12 pt-2 ml-auto" style="direction: ltr;">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{route('shopView',4)}}" method="post" id="chat-form">
                                    @csrf
                                    @if($shop['id'] != 0)
                            ...
                            <div class="card-footer">
                                <a href="{{route('shopView',4)}}" class="btn btn-primary mx-1">
