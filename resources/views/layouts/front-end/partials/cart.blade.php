...
<div class="navbar-tool dropdown {{Session::get('direction') === "rtl" ? 'mr-3' : 'ml-3'}}"
    ...
    <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="{{route('order-cart')}}">
    ...
    <a class="navbar-tool-text" href="{{route('order-cart')}}"><small>{{\App\CPU\translate('my_cart')}}</small>
        ...
        <div class="widget widget-cart px-3 pt-2 pb-3">
            @if($cart->count() > 0)
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                    ...
                    <a class="btn btn-outline-secondary btn-sm" href="{{route('order-cart')}}">
