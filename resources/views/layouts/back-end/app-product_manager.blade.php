...
@include('layouts.back-end.partials-product_manager._header')
@include('layouts.back-end.partials-product_manager._side-bar')
...
<main id="content" role="main" class="main pointer-event" style="background-color: #F7F8FA">
    ...
    <!-- Footer -->
    @include('layouts.back-end.partials-product_manager._footer')
    <!-- End Footer -->

    @include('layouts.back-end.partials-product_manager._modals')
