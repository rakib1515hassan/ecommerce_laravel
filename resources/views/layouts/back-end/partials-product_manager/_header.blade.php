                        ...
                        <div class="hs-unfold">
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    ...
                                    <img class="avatar-img"
                                         onerror="this.src='{{asset('assets/back-end/img/160x160/img1.jpg')}}'"
                                         src="{{asset('storage/product_manager/')}}/{{auth('product_manager')->user()->image}}"
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <span class="card-title h5">{{auth('product_manager')->user()->f_name}}</span>

                                            <span class="card-text">{{auth('product_manager')->user()->email}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a class="dropdown-item"
                                   href="{{route('product_manager.profile.update',auth('product_manager')->user()->id)}}">
                                ...
                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    ...
                                    if (result.value) {
                                    location.href='{{route('product_manager.auth.logout')}}';
                                    } else{
                                    Swal.fire('Canceled', '', 'info')
                                    }
                                    })">
                                    <span class="text-truncate pr-2"
                                          title="Sign out">{{translate('Sign out')}}</span>
                                </a>
                            </div>
                        </div>
                        <!-- End Account -->
