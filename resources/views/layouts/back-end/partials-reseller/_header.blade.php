...
{{--                @php($seller_logo = \App\Models\Shop::where(['seller_id' => auth('seller')->id()])->first()->image)--}}
                ...
                <a class="navbar-brand" href="{{route('reseller.dashboard.index')}}" aria-label="">
                    <img class="navbar-brand-logo" style="max-height: 42px;"
                         onerror="this.src='{{asset('assets/back-end/img/160x160/img1.jpg')}}'"
                         src="{{asset("assets/back-end/img/logo.png") }}" alt="Logo" height="40" width="40">
                    <img class="navbar-brand-logo-mini" style="max-height: 42px;"
                         onerror="this.src='{{asset('assets/back-end/img/160x160/img1.jpg')}}'"
                         src="{{asset("assets/back-end/img/logo.png") }}"
                        ...
                        <div class="hs-unfold">
                               ...
                               data-hs-unfold-options='{
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                    ...
                                    <img class="avatar-img"
                                         onerror="this.src='{{asset('assets/back-end/img/160x160/img1.jpg')}}'"
                                         src="{{asset('storage/reseller/')}}/{{auth('reseller')->user()->image}}"
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <span class="card-title h5">{{auth('reseller')->user()->f_name}}</span>

                                            <span class="card-text">{{auth('reseller')->user()->email}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a class="dropdown-item"
                                   href="{{route('reseller.profile.update',auth('reseller')->user()->id)}}">
                                ...
                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    ...
                                    if (result.value) {
                                    location.href='{{route('reseller.auth.logout')}}';
                                    } else{
