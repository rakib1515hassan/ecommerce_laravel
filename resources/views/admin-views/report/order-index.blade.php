...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row border-bottom border-right border-left border-top">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="exampleInputEmail1"
                                       class="form-label">{{translate('Show data by date range')}}</label>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-6">
                @php
                    $canceled=\App\Models\Order::where(['order_status'=>'processing'])->whereBetween('created_at', [$from, $to])->count()
                @endphp
                    <!-- Card -->
                <div class="card card-sm">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1">{{translate('Processing')}}</h4>
                          ...
                          "gradientPosition": {"y1": 200},
                           "scales": {
                              "yAxes": [{
                                ...
                                "ticks": {
                                  "min": 0,
                                  "max": {{\App\Services\BackEndHelper::max_orders()}},
                                  "stepSize": {{round(\App\Services\BackEndHelper::max_orders()/5)}},
                                  "fontColor": "#97a4af",
                                            ...
                                            <div class="row">
                                                <div class="col-sm mb-2 mb-sm-0">
                                                    <h2 class="font-weight-normal mb-1">#{{$order['id']}} <small
                                                            class="font-size-sm text-body text-uppercase">{{translate('Orders')}} {{translate('ID')}}</small>
                                                    </h2>
                                                    <h5 class="text-hover-primary mb-0">{{translate('Order')}} {{translate('Amount')}}
                                                        : {{\App\Services\BackEndHelper::usd_to_currency($order['order_amount'])}} {{\App\Services\BackEndHelper::currency_symbol()}}</h5>
                                                    <small
                                                ...
                                                <div class="col-sm-auto align-self-sm-end">
                                                    <!-- Avatar Group -->
                                                    <div class="">
                                                        {{translate('Orders')}}  {{str_replace('_',' ',$order['order_status']) }}
                                                        <br></strong>
                                                    </div>
                                                    <!-- End Avatar Group -->
                                                </div>
