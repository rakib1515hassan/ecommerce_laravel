...
@section('title', translate('Inhouse product sale Report'))
                ...
                <ul class="nav nav-tabs page-header-tabs" id="projectsTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="javascript:">{{translate('InHouse product sale report')}}</a>
                    </li>
                </ul>
            </div>
            <!-- End Nav -->
                            ...
                            <div class="flex-between row">
                                <div class="col-2 text-center">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">{{translate('Category')}}</label>
                                    </div>
                                </div>
                                <div class="col-7">
                                    <div class="form-group">
                    ...
                    <div class="card-body"
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th scope="col">
                                    {{translate('Total Sale')}} <label class="badge badge-success ml-3"
                                                                                     style="cursor: pointer">{{translate('ASE/DESC')}}</label>
                                </th>
                            </tr>
                            </thead>
