...
@section('title', translate('Product in Wishlist Report'))
                ...
                <ul class="nav nav-tabs page-header-tabs" id="projectsTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="javascript:">{{translate('Product in wishlist report')}}</a>
                    </li>
                </ul>
            </div>
            <!-- End Nav -->
            ...
            <div class="col-12">
                <div class="card">
                                    ...
                                    <div class="form-group">
                                        <select
                                            ...
                                            <option value="in_house"
                                                    selected>{{translate('In-House')}}</option>
                    ...
                    <div class="card-body" id="products-table"
                         style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"></div>
                </div>
            </div>
        </div>
        <!-- End Stats -->
