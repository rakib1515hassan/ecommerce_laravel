                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                <label for="exampleInputEmail1"
                                       class="form-label">{{translate('show_data_by_date_range')}}</label>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="mb-3">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="font-size-sm text-success">
                                          <i class="tio-trending-up"></i> {{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($total_earning))}}
                                        </span>
                                    </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="font-size-sm text-warning">
                                          <i class="tio-trending-up"></i>  {{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($total_tax))}}
                                        </span>
                                    </div>
                                </div>
                                <!-- End Media -->
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1">{{translate('Total')}} {{translate('commission')}} </h4>
                                        <span class="font-size-sm text-primary">
                                          <i class="tio-trending-up"></i>  {{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($total_commission))}}
                                        </span>
                                    </div>
                                </div>
                                <!-- End Media -->
        ...
        <div class="card mb-3 mb-lg-5 border-top border-left border-right border-bottom">
            ...
            <div class="card-header">
                ...
                <div class="flex-start">
                    ...
                    <h6>
                        <span
                            class="h3 {{Session::get('direction') === "rtl" ? 'mr-sm-2' : 'ml-sm-2'}}"> {{\App\Services\BackEndHelper::usd_to_currency($total_sold)." "}}</span>
                    </h6>
                    <h6>
                        <span
                            class="h3 {{Session::get('direction') === "rtl" ? 'mr-sm-2' : 'ml-sm-2'}}"> {{\App\Services\BackEndHelper::currency_symbol()}}</span>
                    </h6>
                </div>
            ...
            @php
                $sold=[];
                    for ($i=1;$i<=12;$i++){
                        $from = date('Y-'.$i.'-01');
                        $to = date('Y-'.$i.'-30');
                        $sold[$i]=\App\Models\OrderTransaction::where(['status'=>'disburse'])->whereBetween('created_at', [$from, $to])->sum('order_amount');
                    }
            @endphp
            ...
            @php
                $tax=[];
                    for ($i=1;$i<=12;$i++){
                        $from = date('Y-'.$i.'-01');
                        $to = date('Y-'.$i.'-30');
                        $tax[$i]=\App\Models\OrderTransaction::where(['status'=>'disburse'])->whereBetween('created_at', [$from, $to])->sum('tax');
                    }
            @endphp
            @php
                $commission=[];
                    for ($i=1;$i<=12;$i++){
                        $from = date('Y-'.$i.'-01');
                        $to = date('Y-'.$i.'-30');
                        $commission[$i]=\App\Models\OrderTransaction::where(['status'=>'disburse'])->whereBetween('created_at', [$from, $to])->sum('admin_commission');
                    }
            @endphp
