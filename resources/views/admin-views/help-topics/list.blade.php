        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"
                    aria-current="page">{{translate('Dashboard')}}{{translate('help_topic')}}</li>
            </ol>
        </nav>
                        ...
                        <div class="modal-body"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="question"
                                       placeholder="{{translate('Type Question')}}">
                            </div>
                ...
                <form action="" method="post" id="editForm"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>{{translate('Answer')}}</label>
                            <textarea class="form-control" name="answer" cols="5"
                                      rows="5" placeholder="{{translate('Type Answer')}}"
