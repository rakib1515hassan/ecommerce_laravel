...
@section('content')
    @if(auth('admin')->user()->admin_role_id==1 || \App\Services\AdditionalServices::module_permission_check('dashboard'))
                ...
                <div class="flex-between align-items-center">
                    <div>
                        <h1 class="page-header-title"
                            style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">{{translate('Dashboard')}}</h1>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="flex-between gx-2 gx-lg-3 mb-2">
                        <div>
                            <h4><i style="font-size: 30px"
                                   class="tio-chart-line-up"></i>{{translate('admin_wallet')}}</h4>
                        </div>
                    </div>
                    <div class="row gx-2 gx-lg-3" id="order_stats">
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-12 mb-3 border-bottom">
                                    ...
                                    <!-- Legend Indicators -->
                                    <h5 class="card-header-title float-right mb-2">{{translate('this_year_earning')}}
                                ...
                                <div class="col-md-4 col-12 graph-border-1">
                                    ...
                                    <span class="h6 mb-0">
                                        ...
                                        {{translate('in-house_earning')}} : {{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency(array_sum($inhouse_data)))}}
                                    </span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12 graph-border-1">
                                    <div class="mt-2 center-div">
                                      <span class="h6 mb-0">
                                         ...
                                         {{translate('seller_earnings')}} : {{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency(array_sum($seller_data)))}}
                                    </span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12 graph-border-1">
                                    <div class="mt-2 center-div">
                                      <span class="h6 mb-0">
                                        ...
                                        {{translate('commission_earned')}} : {{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency(array_sum($commission_data)))}}
                                    </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header">
                            <h5 class="card-header-title">
                                <i class="tio-company"></i> {{translate('total_business_overview')}}
                            </h5>
                ...
                <div class="row align-items-center">
                    <div class="col-12 mb-2 mb-sm-0">
                        <h3 class="text-center"
                            style="color: gray">{{translate('hi')}} {{auth('admin')->user()->name}}
