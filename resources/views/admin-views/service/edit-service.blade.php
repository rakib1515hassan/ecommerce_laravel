...
@section('title', translate('Service Update'))
...
@section('content')
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">
                    <a href="{{route('admin.service.list')}}">{{translate('Service')}}</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{route('admin.service.update', ['id' => $service->id])}}" method="POST"
                    ...
                    <div class="card card-footer">
                        <div class="row">
                            <div class="col-md-12" style="padding-top: 20px">
                                ...
                                <a class="btn btn-secondary ml-2" href="{{route('admin.service.list')}}">{{translate('Cancel')}}</a>
                            </div>
                        </div>
                    </div>
