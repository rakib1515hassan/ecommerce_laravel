                        ...
                        <div class="row flex-between justify-content-between align-items-center flex-grow-1">
                            <div>
                                <h5 class="flex-between">
                                    <div>{{ translate('Service Table') }}</div>
                            ...
                            <div>
                                <a href="{{ route('admin.service.add-new-service') }}" class="btn btn-primary  float-right">
                                    <i class="tio-add-circle"></i>
                                    <span class="text">{{ translate('Add new service') }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="datatable"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th>{{ translate('Service Category') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span>
                                                    @php
                                                        $name = $service->name;
                                                        $trimmedname = strlen($name) > 40 ? substr($name, 0, 40) . '...' : $name;
                                                    @endphp
                                                    {!! $trimmedname !!}
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('admin.service.show_update_page', ['id' => $service->id]) }}">
