...
@section('title', translate('Service Cagegory Update'))
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{ translate('Update') }} </li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form"
                    action="{{ route('admin.service.category_update_store', ['id' => $category->id]) }}" method="POST"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        placeholder="New Service Name" required value="{{ $category->name }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="category_type" id="category_type" required>
                                        <option value="service"
                                            {{ $category->category_type == 'service' ? 'selected' : '' }}>Service</option>
                                        <option value="car" {{ $category->category_type == 'car' ? 'selected' : '' }}>
                                            Car</option>
                                        <option value="property"
                                            {{ $category->category_type == 'property' ? 'selected' : '' }}>Property
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <!-- <div class="row">
                                        {{-- Logo --}}
                                        <div class="form-group col-md-6">
                                            <label class="input-label" for="logo">{{ translate('logo') }}</label>
                                            <input type="file" name="logo" id="logo" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                            @if ($category->logo)
    <img src="{{ asset('storage/' . $category->logo) }}" class="img-fluid flex-grow-1"
