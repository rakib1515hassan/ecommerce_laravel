                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($transaction['seller_is'] == 'admin')
                                                    ...
                                                    {{ App\Models\BusinessSetting::where(['type' => 'company_name'])->first()->value }}
                                                @else
                                                    {{ App\Models\Seller::find($transaction['seller_id'])->f_name }} {{ App\Models\Seller::find($transaction['seller_id'])->l_name }}
                                                @endif
