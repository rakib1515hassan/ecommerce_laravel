                            ...
                            <table id="datatable"
                                ...
                                @foreach($product as $k=>$p)
                                    <tr>
                                        ...
                                        <td>
                                            {{ \App\Services\BackEndHelper::usd_to_currency($p['purchase_price']).\App\Services\BackEndHelper::currency_symbol()}}
                                        </td>
                                        <td>
                                            {{ \App\Services\BackEndHelper::usd_to_currency($p['unit_price']).\App\Services\BackEndHelper::currency_symbol()}}
                                        </td>
                                        <td>
                                            <label class="switch">
                                                <input type="checkbox"
