                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">{{translate('Order details')}}</li>
                        </ol>
                    </nav>
                    ...
                    <div class="d-sm-flex align-items-sm-center">
                        ...
                        @elseif($order['order_status']=='processing'|| $order['order_status']=='out_for_delivery')
                            <span
                                    class="badge badge-soft-warning {{Session::get('direction') === "rtl" ? 'mr-2 mr-sm-3' : 'ml-2 ml-sm-3'}} text-capitalize">
                          <span class="legend-indicator bg-warning"
                                style="{{Session::get('direction') === "rtl" ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;'}}"></span>{{str_replace('_',' ',$order['order_status'])}}
                        </span>
                        @elseif($order['order_status']=='delivered'|| $order['order_status']=='confirmed')
                            <span
                                    class="badge badge-soft-success {{Session::get('direction') === "rtl" ? 'mr-2 mr-sm-3' : 'ml-2 ml-sm-3'}} text-capitalize">
                          <span class="legend-indicator bg-success"
                                style="{{Session::get('direction') === "rtl" ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;'}}"></span>{{str_replace('_',' ',$order['order_status'])}}
                        </span>
                        @else
                            ...
                            <div class="col-12 text-right">
                                <div>
                                    <h6 class="text-capitalize"
                                        style="display: inline; color: #8a8a8a; ">{{translate('payment')}} {{translate('method')}}
                                        :</h6>
                                    <h6 class="mx-1"
                                        style="display: inline; color: #8a8a8a;">{{str_replace('_',' ',$order['payment_method'])}}</h6>
                                </div>
                                <div>
                                    <h6 style="display: inline; color: #8a8a8a;">{{translate('Payment')}} {{translate('reference')}}
                                        :</h6>
                                    <h6 class="mx-1"
                                        style="display: inline; color: #8a8a8a;">{{str_replace('_',' ',$order['transaction_ref'])}}</h6>
                                </div>
                                <div>
                                    <h6 class="text-capitalize"
                                        style="display: inline; color: #8a8a8a; ">{{translate('shipping')}} {{translate('method')}}
                                        :</h6>
                                    <h6 class="mx-1"
                                        style="display: inline; color: #8a8a8a;">{{str_replace('_',' ',$order->shipping->title)}}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            ...
                                            <div class="col col-md-1 align-self-center p-0 ">
                                                <h6>{{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($detail['price']))}}</h6>
                                            </div>
                                            ...
                                            <div class="col col-md-1 align-self-center  p-0 product-name">
                                                <h6>{{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($detail['tax']))}}</h6>
                                            </div>
                                            <div class="col col-md-2 align-self-center  p-0 product-name">

                                                <h5>  {{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($detail['discount']))}}</h5>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <h5>{{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($subtotal))}}</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    <dd class="col-sm-6 border-bottom">
                                        <strong>- {{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($coupon_discount))}}</strong>
                                    </dd>
                    ...
                    @if($order->customer)
                        ...
                        <div class="card-body"
                            ...
                            <div class="media align-items-center" href="javascript:">
                                ...
                                <div class="media-body">
                                    <span class="text-body text-hover-primary"> {{\App\Models\Order::where('customer_id',$order['customer_id'])->count()}} orders</span>
                                </div>
                                <div class="media-body text-right">
                                    {{--<i class="tio-chevron-right text-body"></i>--}}
                                </div>
