        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"
                    aria-current="page">{{translate('Push Notification Setup')}}</li>
            </ol>
        </nav>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span
                                                class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">{{translate('Order Pending Message')}}</span>
                                          </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}"> {{translate('Order Confirmation Message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">{{translate('Order Processing Message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">{{translate('Order out for delivery Message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">{{translate('Order Delivered Message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">{{translate('Order Returned Message')}}</span>
                                              </span>
                                        </label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label class="toggle-switch d-flex align-items-center mb-3"
                                            ...
                                            <span class="toggle-switch-content">
                                                <span
                                                    class="d-block {{Session::get('direction') === "rtl" ? 'mr-2' : ''}}">{{translate('Order Failed Message')}}</span>
                                              </span>
                                        </label>
