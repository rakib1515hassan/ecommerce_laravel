    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{translate('privacy_policy')}}</li>
            </ol>
        </nav>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row justify-content-between pl-4 pr-4">
                            <div>
                                <h2>{{translate('privacy_policy')}}</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{{route('admin.business-settings.privacy-policy')}}" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <label for="editor">{{translate('privacy_policy')}}</label><textarea
