                        ...
                        <form style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="name"
                                               class="{{Session::get('direction') === "rtl" ? 'mr-1' : ''}}">{{translate('name')}}</label>
                                        <select class="form-control" name="name" id="name" style="width: 100%">
                                            ...
                                            <option value="google-plus">{{translate('Google plus')}}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-12 mt-2">
                                        <input type="hidden" id="id">
                                        <label for="link"
                                               class="{{Session::get('direction') === "rtl" ? 'mr-1' : ''}}">{{ translate('social_media_link')}}</label>
                                        <input type="text" name="link" class="form-control" id="link"
                                               placeholder="{{translate('Enter Social Media Link')}}"
                                               required>
                                    </div>
                                    <div class="col-md-12">
                                        <input type="hidden" id="id">
                            ...
                            <div class="card-footer">
                                <a id="add" class="btn btn-primary"
                                   style="color: white">{{ translate('save')}}</a>
