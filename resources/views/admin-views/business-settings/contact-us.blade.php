    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{translate('Contact_us')}}</li>
            </ol>
        </nav>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row justify-content-between pl-4 pr-4">
                            <div>
                                <h5><b>{{translate('Contact Us')}}</b></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="{{route('admin.business-settings.contact-update')}}" method="post">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <textarea name="contact_us" id="editor" cols="30" rows="20"
                                              class="form-control">{{$contact_us->value}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
