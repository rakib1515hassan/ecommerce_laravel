...
@section('title', translate('Web Config'))
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"
                    aria-current="page">{{translate('Website')}} {{translate('Info')}} </li>
            </ol>
        </nav>
        ...
        <div class="row" style="padding-bottom: 20px;">
                ...
                <div class="card">
                    <div class="card-body" style="padding-bottom: 12px">
                        <div class="row flex-between mx-1">
                            @php($config=\App\Services\AdditionalServices::get_business_settings('maintenance_mode'))
                            <div class="flex-between">
                                <h5 class="{{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}"><i
                                            class="tio-settings-outlined"></i></h5>
                                <h5>{{translate('maintenance_mode')}}</h5>
                            </div>
                            <div>
                                <label
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center"><i
                                    class="tio-money"></i> {{translate('Currency Symbol Position')}}</h5>
                        <i class="tio-dollar"></i>
                    </div>
                    <div class="card-body">
                        @php($config=\App\Services\AdditionalServices::get_business_settings('currency_symbol_position'))
                        <div class="form-row">
                                    ...
                                    <div class="custom-control custom-radio custom-radio-reverse"
                                        ...
                                        <label class="custom-control-label media align-items-center"
                                            ...
                                            <span class="media-body">
                                               {{\App\Services\BackEndHelper::currency_symbol()}} {{translate('Left')}}
                                              </span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-control">
                                    <div class="custom-control custom-radio custom-radio-reverse"
                                        ...
                                        <label class="custom-control-label media align-items-center"
                                            ...
                                            <span
                                                    class="media-body">{{translate('Right')}} {{\App\Services\BackEndHelper::currency_symbol()}}</span>
                                        </label>
                                    </div>
                                </div>
                                <!-- End Custom Radio -->
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center">{{translate('apple_store')}} {{translate('Status')}}</h5>
                    </div>
                    <div class="card-body" style="padding: 20px">

                        @php($config=\App\Services\AdditionalServices::get_business_settings('download_app_apple_stroe'))
                        <form style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label
                                            style="padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 10px">{{translate('link')}}</label><br>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center">{{translate('google_play_store')}} {{translate('Status')}}</h5>
                    </div>
                    <div class="card-body" style="padding: 20px">

                        @php($config=\App\Services\AdditionalServices::get_business_settings('download_app_google_stroe'))
                        <form style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
        ...
        <div
            ...
            <form action="{{ route('admin.business-settings.update-info') }}" method="POST"
                            ...
                            <div class="card-header">
                                <div class="flex-between">
                                    <div class="flex-between">
                                        ...
                                        <h5>{{translate('Admin Shop Banner')}}</h5>
                                    </div>
                                    <div class="{{Session::get('direction') === "rtl" ? 'mr-1' : 'ml-1'}}"><small
                                                style="color: red">{{translate('Ratio')}}
                                            ( {{translate('6:1')}} )</small></div>
                                </div>
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img height="200" style="width: 100%" id="viewerShop"
                                         ...
                                         src="{{asset('storage/order')}}/{{\App\Services\AdditionalServices::get_business_settings('shop_banner')}}">
                                </center>
                                <hr>
                ...
                <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label
                                    class="input-label">{{translate('company')}} {{translate('name')}}</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label
                                    class="input-label">{{translate('company')}} {{translate('Email')}}</label>
                ...
                <div class="row" style="padding-bottom: 20px">
                    ...
                    @php($default_location=\App\Services\AdditionalServices::get_business_settings('default_location'))
                    <div class="col-md-4">
                        <div class="form-group">
                            <label
                                    class="input-label">{{translate('latitude')}}</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label
                                    class="input-label">{{translate('longitude')}}</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label
                                    class="input-label">{{translate('minimum_stock_limit_for_warning')}}</label>
                            <input class="form-control" type="number" name="stock_limit"
                                   value="{{ $stock_limit->value?$stock_limit->value:"" }}"
                                   placeholder="{{translate('EX:123')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        @php($pagination_limit=\App\Services\AdditionalServices::get_business_settings('pagination_limit'))
                        <div class="form-group">
                            <label
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label
                                    class="input-label">{{translate('rename_company')}} {{translate('copy_right')}} {{translate('Text')}}</label>
                ...
                <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label
                                    class="input-label d-inline text-capitalize">{{translate('time')}} {{translate('zone')}}</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label
                                    class="input-label d-inline text-capitalize">{{translate('country')}} </label>
                    ...
                    @php($fpv=\App\Services\AdditionalServices::get_business_settings('forgot_password_verification'))
                    <div class="col-md-4">
                        <div class="form-group">
                            <label
                                    class="input-label d-inline text-capitalize">{{translate('forgot_password_verification_by')}} </label>
                ...
                <div class="row">
                    <div class="col-md-4 col-12">
                        @php($pv=\App\Services\AdditionalServices::get_business_settings('phone_verification'))
                        <div class="form-group">
                            <label>{{translate('phone')}} {{translate('verification')}} (
                                OTP
                    ...
                    <div class="col-md-4 col-12">
                        @php($ev=\App\Services\AdditionalServices::get_business_settings('email_verification'))
                        <div class="form-group">
                    ...
                    <div class="col-md-4 col-12">
                        @php($order_verification=\App\Services\AdditionalServices::get_business_settings('order_verification'))
                        <div class="form-group">
                            <label>{{translate('order')}} {{translate('verification')}}</label><small
                                    style="color: red">*</small>
                            <div class="input-group input-group-md-down-break">
                                <!-- Custom Radio -->
                                <div class="form-control">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label"
                                               for="order_verification1">{{translate('on')}}</label>
                                    </div>
                                </div>
                                <!-- End Custom Radio -->
                                ...
                                <div class="form-control">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label"
                                               for="order_verification2">{{translate('off')}}</label>
                                    </div>
                                </div>
                                <!-- End Custom Radio -->
                            </div>
                ...
                <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>{{translate('Web')}} {{translate('logo')}} </h5>
                                ...
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                                        ...
                                        <label class="custom-file-label"
                                               for="customFileUploadWL">{{translate('choose')}} {{translate('file')}}</label>
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h5>{{translate('Mobile')}} {{translate('logo')}} </h5>
                                ...
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                                        <input type="file" name="company_mobile_logo" id="customFileUploadML"
                                               ...
                                               accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label"
                                               for="customFileUploadML">{{translate('choose')}} {{translate('file')}}</label>
                                    </div>
                                </div>
                ...
                <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header">
                                <h5>{{translate('web_footer')}} {{translate('logo')}} </h5>
                                <span class="badge badge-soft-danger">( 250x60 px )</span>
                            </div>
                            <div class="card-body" style="padding: 20px">
                                <center>
                                ...
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                                        <input type="file" name="company_footer_logo" id="customFileUploadWFL"
                                               ...
                                               accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label"
                                               for="customFileUploadWFL">{{translate('choose')}} {{translate('file')}}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                                        <input type="file" name="company_fav_icon" id="customFileUploadFI"
                                               ...
                                               accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label"
                                               for="customFileUploadFI">{{translate('choose')}} {{translate('file')}}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img width="60" id="viewerLoader"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         src="{{asset('storage/company')}}/{{\App\Services\AdditionalServices::get_business_settings('loader_gif')}}">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                                        <input type="file" name="loader_gif" id="customFileUploadLoader"
                                               ...
                                               accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label"
                                               for="customFileUploadLoader">{{translate('choose')}} {{translate('file')}}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row" style="padding-bottom: 20px">
                        ...
                        <div class="card">
                            <div class="card-body" style="padding: 20px">
                                ...
                                @else
                                    ...
                                    @php($data=json_decode($colors['value']))
                                @endif
                                <h4>{{translate('web_color_setup')}}</h4>
                                <div class="form-group">
                    ...
                    @php($announcement=\App\Services\AdditionalServices::get_business_settings('announcement'))
                    @if (isset($announcement))
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body" style="padding: 20px">

                                    <h4>{{translate('announcement_setup')}}</h4>
                                    <div class="form-group mb-2 mt-2">
                                    ...
                                    <div class="form-group">
                                        <label>{{translate('text_color')}}</label>
