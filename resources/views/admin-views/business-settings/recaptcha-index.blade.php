            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        <div class="mt-4">
                            @php($config=\App\Services\AdditionalServices::get_business_settings('recaptcha'))
                            <form
                                action="{{env('APP_MODE')!='dev'?route('admin.business-settings.recaptcha_update',['recaptcha']):'javascript:'}}"
                                method="post">
                                @csrf
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="site_key"
                                           value="{{env('APP_MODE')!='dev'?$config['site_key']??"":''}}">
                                </div>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="secret_key"
                                           value="{{env('APP_MODE')!='dev'?$config['secret_key']??"":''}}">
                                </div>
