        ...
        <div class="row">
            <div class="col-md-12" id="banner-btn">
                <button id="main-banner-add" class="btn btn-primary"><i
                        class="tio-add-circle"></i> {{ translate('add_banner')}}</button>
            </div>
        </div>
        <!-- Content Row -->
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.banner.store')}}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="card-footer">
                                <a class="btn btn-secondary text-white cancel">{{ translate('Cancel')}}</a>
                    ...
                    <div class="card-header">
                        <div class="flex-between row justify-content-between align-items-center flex-grow-1 mx-1">
                            <div class="flex-between">
                                <div><h5>{{ translate('banner_table')}}</h5></div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                       ...
                                                       style="cursor: pointer;"> {{ translate('Edit')}}</a>
                                                    <a class="dropdown-item delete" style="cursor: pointer;"
                                                       id="{{$banner['id']}}"> {{ translate('Delete')}}</a>
                                                </div>
                                            </div>
