...
<header id="header"
    ...
    <div class="navbar-nav-wrap">
        <div class="navbar-brand-wrapper">
            ...
            @php($company_name=\App\Models\BusinessSetting::where(['type'=>'company_name'])->first()->value)
            {{$company_name}}
        </div>
                    ...
                    <div class="card">
                        <div class="w-100">
                            <div class="d-flex flex-row p-1">
                                <select id='customer' name="customer_id" data-placeholder="Walk In Customer"
