            ...
            <th style="text-align: right">
                <table style="width: 46%;margin-left:41%; display: inline " class="text-right sm-padding strong bs-0">
                    ...
                    <tr class="bg-primary" style="background-color: #2D7BFF">
                        ...
                        <td class="text-white">
                            {{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($order->order_amount))}}
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <tr>
                <th class="content-position-y bg-primary"
                    ...
                    <div class="text-white" style="padding-top:5px; padding-bottom:2px;"><i
                            ...
                            aria-hidden="true"></i> {{translate('website')}}
                        : {{url('/')}}</div>
                    <div class="text-white" style="padding-top:5px; padding-bottom:2px;"><i
                            class="fa fa-envelope text-white"
                            aria-hidden="true"></i> {{translate('email')}}
                        : {{$company_email}}</div>
                </th>
