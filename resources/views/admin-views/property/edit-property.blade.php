...
@section('title', translate('Property Service Update'))
...
@section('content')
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">
                    <a href="{{route('admin.car.list')}}">{{translate('property')}}</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{route('admin.property.update', ['id' => $service->id])}}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="write property title"
