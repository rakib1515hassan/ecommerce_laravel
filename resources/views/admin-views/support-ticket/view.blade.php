    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{translate('support_ticket')}}</li>
            </ol>
        </nav>
                ...
                <div class="card">
                    <div class="card-header">
                        {{-- <div class="row justify-content-between pl-4 pr-4">
                            <div>
                                <h5>{{translate('support_ticket')}}</h5>
                            </div>
                            <div>
                                <!-- Modal -->
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"
                                                    id="exampleModalLabel">{{translate('Currency')}}</h5>
                                                ...
                                                <form action="#" method="post">
                                                    ...
                                                    <div class="form-group text-center">
                                                        <button type="submit" id="add" class="btn btn-primary"
                                                                style="color: white">{{translate('Save')}}</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                        ...
                        <div class="flex-between row justify-content-between align-items-center flex-grow-1 mx-1">
                            <div class="flex-start">
                                <div><h5>{{translate('support_ticket')}}</h5></div>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a href="{{route('admin.support-ticket.singleTicket',$ticket['id'])}}"
                                               class="btn btn-primary   btn-sm">{{translate('View')}}</a>
                                        </td>
                                    </tr>
                                @endforeach
