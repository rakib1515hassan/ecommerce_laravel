...
@section('title', translate('Car Add'))
...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{ route('admin.car.store') }}" method="POST"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group ">
                                <label class="input-label" for="">{{ translate('car_category') }}</label>
