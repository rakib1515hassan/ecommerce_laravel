...
@section('title', translate('Car List'))
    ...
    <div class="content container-fluid"> <!-- Page Heading -->
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ translate('Car') }}</li>
            </ol>
        </nav>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row flex-between justify-content-between align-items-center flex-grow-1">
                                ...
                                <form action="{{ url()->current() }}" method="GET" id="filter_form">
                                    <div class="input-group input-group-merge input-group-flush">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                            placeholder="{{ translate('Search Car Title') }}" aria-label="Search orders"
                                            value="" required>
                            ...
                            <div>
                                <a href="{{ route('admin.car.add-new-car') }}" class="btn btn-primary  float-right">
                                    <i class="tio-add-circle"></i>
                                    <span class="text">{{ translate('Add new car service') }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="datatable"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        <th>{{ translate('SL#') }}</th>
                                        <th>{{ translate('Car Service Name') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm"
                                                    href="{{ route('admin.car.show_update_page', ['id' => $service->id]) }}">
                                                ...
                                                <form action="{{ route('admin.car.delete', [$service['id']]) }}"
