                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ translate('Customer details') }}</li>
                        </ol>
                    </nav>

                    <div class="d-sm-flex align-items-sm-center">
                        <h1 class="page-header-title">{{ translate('Customer ID') }}
                            #{{ $customer['id'] }}</h1>
                    ...
                    <div class="row border-top pt-3">
                        <div class="col-12">
                            ...
                            <a class="btn btn-danger btn-sm" href="javascript:"
                                onclick="form_alert('customer-{{ $customer['id'] }}','Want to delete this item ?')">
                        ...
                        <form action="{{ url()->current() }}" method="GET">
                            ...
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="{{ translate('Search orders') }}" aria-label="Search orders"
                    ...
                    <div class="table-responsive datatable-custom">
                        <table
                            ...
                            <thead class="thead-light">
                                <tr>
                                    <th>{{ translate('sl') }}#</th>
                                    <th style="width: 50%" class="text-center">{{ translate('Order ID') }}</th>
                            ...
                            <tbody>
                                @foreach ($orders as $key => $order)
                                    <tr>
                                        ...
                                        <td> {{ \App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($order['order_amount'])) }}
                                        </td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.orders.details', ['id' => $order['id']]) }}"><i
                                                            class="tio-visible"></i> {{ translate('View') }}
                                                    </a>
                                                    <a class="dropdown-item" target="_blank"
                                                        href="{{ route('admin.orders.generate-invoice', [$order['id']]) }}"><i
                                                            class="tio-download"></i> {{ translate('Invoice') }}
                                                    </a>
                                                </div>
                                            </div>
                                            <!-- End Dropdown -->
                            ...
                            <div class="media align-items-center" href="javascript:">
                                <div
                                    ...
                                    <img class="avatar-img"
                                        ...
                                        src="{{ asset('storage/profile/' . $customer->image) }}" alt="Image Description">
                                </div>
