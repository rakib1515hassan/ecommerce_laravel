        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"
                    aria-current="page">{{translate('Shipping Method by Seller')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{translate('shipping_method')}} {{translate('table')}}
                            ( {{translate('Suggested')}} )</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"
                                ...
                                @foreach($shipping_methods as $k=>$method)
                                    <tr>
                                        ...
                                        <td>
                                            {{\App\Services\BackEndHelper::usd_to_currency($method['cost']) .\App\Services\BackEndHelper::currency_symbol()}}
                                        </td>
