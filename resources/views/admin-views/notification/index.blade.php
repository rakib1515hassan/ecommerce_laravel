            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-header">
                        <h1 class="page-header-title">{{translate('Notification')}} </h1>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.notification.store')}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control"
                                       placeholder="{{translate('New notification')}}"
                                       required>
                            </div>
                            <div class="form-group">
                                <label class="input-label"
                            ...
                            <hr>
                            <button type="submit"
                                    class="btn btn-primary">{{translate('Send')}}  {{translate('Notification')}}  </button>
                        </form>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-header">
                        <div class="row justify-content-between align-items-center flex-grow-1 mx-1">
                            <div class="flex-between">
                                <div>{{ translate('Notification_Table')}}</div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item delete" href="javascript:"
                                                   id="{{$notification['id']}}')">{{translate('Delete')}} </a>
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        data: {id: id},
                        success: function () {
                            toastr.success('{{translate('notification deleted successfully')}}');
                            location.reload();
                        }
                    });
                }
