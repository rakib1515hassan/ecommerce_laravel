            ...
            <div class="flex-between row mx-1">
                ...
                <div class="row">
                    <div class="col-12 flex-start">
                        ...
                        <div>
                            <a href="{{env('APP_URL')}}/product/{{$product['slug']}}" class="btn btn-primary "
                               target="_blank"><i
                                    class="tio-globe"></i> {{ translate('View') }} {{ translate('from') }} {{ translate('Website') }}
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"
                                            id="exampleModalLabel">{{ translate('denied_note') }}</h5>
                ...
                <div class="row align-items-md-center gx-md-5">
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            <img
                                ...
                                src="{{\App\Services\ProductManager::product_image_path('thumbnail')}}/{{$product['thumbnail']}}"
                    ...
                    <div class="col-md">
                        <ul class="list-unstyled list-unstyled-py-2 mb-0">
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                @php($five=\App\Services\AdditionalServices::rating_count($product['id'],5))
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">{{translate('5 star')}}</span>
                            ...
                            <!-- Review Ratings -->
                            <li class="d-flex align-items-center font-size-sm">
                                @php($four=\App\Services\AdditionalServices::rating_count($product['id'],4))
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">{{translate('4 star')}}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <!-- Review Ratings -->
                            <li class="d-flex align-items-center font-size-sm">
                                @php($three=\App\Services\AdditionalServices::rating_count($product['id'],3))
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">{{translate('3 star')}}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <!-- Review Ratings -->
                            <li class="d-flex align-items-center font-size-sm">
                                @php($two=\App\Services\AdditionalServices::rating_count($product['id'],2))
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">{{translate('2 star')}}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <!-- Review Ratings -->
                            <li class="d-flex align-items-center font-size-sm">
                                @php($one=\App\Services\AdditionalServices::rating_count($product['id'],1))
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">{{translate('1 star')}}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                    ...
                    <div class="col-4 pt-2">
                        ...
                        <div class="flex-start">
                            ...
                            <span
                                class="mx-1">{{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($product['unit_price']))}}</span>
                        </div>
                        <div class="flex-start">
                        ...
                        <div class="flex-start">
                            ...
                            <span
                                class="mx-1">{{ $product->discount_type=='flat'?(\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($product['discount']))): $product->discount.''.'%'}} </span>
                        </div>
                        <div class="flex-start">
