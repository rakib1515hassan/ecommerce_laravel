        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                            href="{{route('admin.product.list', ['in_house',''])}}">{{translate('Product')}}</a>
                </li>
        ...
        <div class="row" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
            <div class="col-12">
                <div class="jumbotron" style="background: white">
                    ...
                    <p>
                        4. {{translate('After uploading products you need to edit them and set product images and choices')}}
                        .</p>
