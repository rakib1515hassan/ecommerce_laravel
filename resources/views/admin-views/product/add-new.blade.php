                ...
                <form class="product-form" action="{{route('admin.product.store')}}" method="POST"
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            ...
                            {{--                                    @if(auth('seller')->user()->admin_manage == 1)--}}
                            {{--                                        <div class="col-md-2">--}}
                            {{--                                            <div class="custom-control custom-switch">--}}
                            {{--                                                <input type="checkbox" class="custom-control-input" id="is_admin_manage"--}}
                            {{--                                                       name="is_admin_manage" value="1">--}}
                            {{--                                                <label class="custom-control-label" for="is_admin_manage">Admin--}}
                            {{--                                                    Manage</label>--}}
                            {{--                                            </div>--}}
                            {{--                                        </div>--}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select
                                            ...
                                            @foreach (Color::orderBy('name', 'asc')->get() as $key => $color)
