...
@section('title', translate('Brand Edit'))
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"
                    aria-current="page">{{ translate('Brand')}} {{ translate('Update')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h1 class="h3 mb-0 text-black-50">{{ translate('Brand')}} {{ translate('Update')}}</h1>
                    </div>
                    <div class="card-body"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="brand">{{ translate('brand_logo')}}</label><span
