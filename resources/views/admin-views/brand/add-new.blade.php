...
@section('title', translate('Brand Add'))
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{translate('brand')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ translate('Add')}} {{ translate('new')}} {{ translate('brand')}}
                    </div>
                    <div class="card-body"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="name">{{ translate('brand_logo')}}</label><span
