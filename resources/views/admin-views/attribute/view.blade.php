    ...
    <div class="content container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ translate('Attribute')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12" style="margin-bottom: 10px;">
                <div class="card">
                    <div class="card-header">
                        {{ translate('Add')}} {{ translate('new')}} {{ translate('Attribute')}}
                    </div>
                    <div class="card-body"
                        ...
                        <form action="{{route('admin.attribute.store')}}" method="post">
                            ...
                            @foreach(json_decode($language) as $lang)
                                <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                    ...
                                    <label
                                            for="name">{{ translate('Attribute')}} {{ translate('Name')}}
                                        ({{strtoupper($lang)}})</label>
                                    <input type="text" name="name[]" class="form-control" id="name"
                                           placeholder="{{translate('Enter_Attribute_Name')}}" {{$lang == $default_lang? 'required':''}}>
                                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="flex-between justify-content-between align-items-center flex-grow-1">
                            <div>
                                <h5>{{ translate('Attribute')}} {{ translate('Table')}}
                                    <span
                                            style="color: red;">({{ $attributes->total() }})</span></h5>
                            </div>
                    ...
                    <div class="card-body"
                         style="padding: 0; text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <div class="table-responsive">
                            <table id="datatable"
                                ...
                                <tr>
                                    <th style="width: 30px">{{ translate('SL#')}}</th>
                                    <th>{{ translate('Name')}} </th>
                                    <th style="width: 60px">{{ translate('Action')}}</th>
                                </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <a class="dropdown-item delete" style="cursor: pointer;"
                                                       id="{{$attribute['id']}}">  {{ translate('Delete')}}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <script>
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                text: "{{translate('You_will not_be_able_to_revert_this')}}!",
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        data: {id: id},
                        success: function () {
                            toastr.success('{{translate('Attribute_deleted_successfully')}}');
                            location.reload();
                        }
                    });
                }
