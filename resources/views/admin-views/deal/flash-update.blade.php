...
@section('title', translate('Flash Deal Update'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{translate('Flash Deal')}}</li>
                <li class="breadcrumb-item">{{translate('Update Deal')}}</li>
            </ol>
        </nav>
                        ...
                        <form action="{{route('admin.deal.update',[$deal['id']])}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="name">{{ translate('end_date')}}</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 pt-3">
                                        <label
                                                for="name">{{translate('Upload')}} {{translate('Image')}}</label><span
                                                class="badge badge-soft-danger">( {{translate('ratio')}} 5:1 )</span>
