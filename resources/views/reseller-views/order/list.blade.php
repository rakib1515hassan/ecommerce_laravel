                            ...
                            <table id="datatable"
                                ...
                                @foreach($orders as $k=>$order)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('reseller.orders.details',$order['id'])}}">{{$order['id']}}</a>
                                        </td>
                                        ...
                                        <td class="text-capitalize ">
                                            @if($order->order_status=='pending')
                                                <label
                                                        class="badge badge-primary">{{translate($order['order_status'])}}</label>
                                            @elseif($order->order_status=='processing' || $order->order_status=='out_for_delivery')
                                                <label
                                                        class="badge badge-warning">{{translate($order['order_status'])}}</label>
                                            @elseif($order->order_status=='delivered' || $order->order_status=='confirmed')
                                                <label
                                                        class="badge badge-success">{{translate($order['order_status'])}}</label>
                                            @elseif($order->order_status=='returned')
                                                <label
                                                        class="badge badge-danger">{{translate($order['order_status'])}}</label>
                                            @else
                                                <label
                                                        class="badge badge-danger">{{translate($order['order_status'])}}</label>
                                            @endif
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                       href="{{route('reseller.orders.details',[$order['id']])}}"><i
                                                                class="tio-visible"></i> {{translate('view')}}
                                                    </a>
                                                    <a class="dropdown-item" target="_blank"
                                                       href="{{route('reseller.orders.generate-invoice',[$order['id']])}}"><i
