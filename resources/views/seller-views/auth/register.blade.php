                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{route('seller.order.apply')}}" method="post"
                                  enctype="multipart/form-data">
                                @csrf
                                <h3 class="black">{{translate('Seller')}} {{translate('Info')}} </h3>
                                            ...
                                            <div class="form-group">
                                                <div class="custom-file" style="text-align: left">
                                                    ...
                                                    <label class="custom-file-label"
                                                           for="customFileUpload">{{translate('Upload')}} {{translate('Image')}}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <h3 class="black">{{translate('Shop')}} {{translate('Information')}}</h3>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 mb-3  ">
                                        <textarea name="shop_address" class="form-control" id="shop_address" rows="3"
                                        ...
                                        <div class="form-group">
                                            <div class="custom-file" style="text-align: left">
                                                <input type="file" name="logo" id="LogoUpload" class="custom-file-input"
                                                       accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                                <label class="custom-file-label"
                                                       for="LogoUpload">{{translate('Upload')}} {{translate('logo')}}</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-file" style="text-align: left">
                                                ...
                                                <label class="custom-file-label"
                                                       for="BannerUpload">{{translate('Upload')}} {{translate('Banner')}}</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div
                                            class="pass invalid-feedback">{{translate('Repeat')}}  {{translate('password')}} {{translate('not match')}}
                                            .
                                        </div>
                                    </div>
                                </div>
