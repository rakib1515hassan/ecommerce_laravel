    ...
    <div class="content container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                                class="tio-add-circle-outlined"></i> {{translate('add')}} {{translate('new')}} {{translate('deliveryman')}}
                    </h1>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('seller.delivery-man.store')}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{translate('identity')}} {{translate('image')}}</label>
                                        <div>
                            ...
                            <div class="form-group">
                                <label>{{translate('deliveryman')}} {{translate('image')}}</label><small
