        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{route('seller.dashboard.index')}}"> {{translate('Dashboard')}}</a>
                </li>
                        ...
                        <div class="flex-between row justify-content-between align-items-center flex-grow-1 mx-1">
                            <div>
                                <div class="flex-start">
                                    ...
                                    {{-- <div class="mx-1">
                                        <h5 style="color: rgb(252, 59, 10);">({{ $reviews->total() }})</h5>
                                    </div> --}}
                                </div>
                            </div>
                            ...
                            ? 'right' : 'left' }};"
                                ...
                                @foreach($qas as $qa)
                                    <tr>
                                        ...
                                        <td>
                                            <label
                                                class="uppercase badge @if($qa->status == 'read') badge-soft-info @else badge-soft-danger @endif">
                                                {{$qa->status}}
                                            </label>
                                        </td>
                                        <td>
                                            <a href="{{ route('seller.business-settings.qa.show',$qa->id)}}"
