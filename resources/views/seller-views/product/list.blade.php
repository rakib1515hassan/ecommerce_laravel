                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            ...
                            <div class="col-lg-4">
                                <a href="{{route('seller.product.add-new')}}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($p->product_manager)
                                                <label class="switch">
                                                    <input type="checkbox" class="product_manager_status"
                                                           id="{{$p['id']}}" {{$p->product_manager_status == 1?'checked':''}}>
                                                    <span class="slider round"></span>
                                                </label>
                                            @else
                                                <label
                                                    class="badge badge-secondary">{{translate('Not Assigned')}}</label>
                                            @endif
                                        </td>
...
@push('script')
    ...
    <script>
        ...
        $(document).on('change', '.product_manager_status', function () {
            var id = $(this).attr("id");
            if ($(this).prop("checked") == true) {
                var status = 1;
            } else if ($(this).prop("checked") == false) {
