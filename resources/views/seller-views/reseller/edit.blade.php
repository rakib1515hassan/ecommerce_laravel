...
@section('title',translate('Update Reseller'))
    ...
    <div class="content container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                                class="tio-edit"></i> {{translate('update')}} {{translate('Reseller')}}
                    </h1>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('seller.reseller.update',[$reseller['id']])}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$reseller['f_name']}}" name="f_name"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$reseller['l_name']}}" name="l_name"
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" value="{{$reseller['email']}}" name="email"
                                               class="form-control"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" value="{{$reseller['phone']}}"
                                               class="form-control"
                                               placeholder="Ex : 017********"
                                               required>
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="identity_type" class="form-control">
                                            <option
                                                    value="passport" {{$reseller['identity_type']=='passport'?'selected':''}}>
                                                {{translate('passport')}}
                                            </option>
                                            <option
                                                    value="driving_license" {{$reseller['identity_type']=='driving_license'?'selected':''}}>
                                                {{translate('driving')}} {{translate('license')}}
                                            </option>
                                            <option value="nid" {{$reseller['identity_type']=='nid'?'selected':''}}>{{translate('nid')}}
                                            </option>
                                            <option
                                                    value="company_id" {{$reseller['identity_type']=='company_id'?'selected':''}}>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="identity_number"
                                               value="{{$reseller['identity_number']}}"
                                               class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <center>
                                    <img style="height: 200px;border: 1px solid; border-radius: 10px;" id="viewer"
                                         src="{{asset('storage/reseller').'/'.$reseller['image']}}"
                                         alt="reseller image"/>
                                </center>
                            </div>
                            <hr>
