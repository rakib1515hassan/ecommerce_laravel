...
<head>
    ...
    <!-- Title -->
    <title>{{translate('product_manager_login')}}</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <!-- Form -->
                        <form id="form-id" action="{{route('product_manager.auth.login')}}" method="post">
                            @csrf
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    ...
                                    <center>
                                        <h1 class="h4 text-gray-900 mb-4">{{translate('welcome_back_to_product_manager_login')}}</h1>
                                    </center>
                                </div>
                            ...
                            <div class="js-form-message form-group">
                                <label class="input-label" for="signupSrPassword" tabindex="0">
                                    <span class="d-flex justify-content-between align-items-center"
                                      ...
                                      {{translate('password')}}
                                            <a href="{{route('product_manager.auth.forgot-password')}}">
                        ...
                        <a href="{{route('product_manager.auth.apply')}}" class="mt-4 btn btn-lg btn-block btn-outline-primary">
