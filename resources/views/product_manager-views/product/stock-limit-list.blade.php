                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            ...
                            <div class="col-12 mt-1 col-md-6 col-lg-3">
                                <select name="qty_ordr_sort" class="form-control"
                                        onchange="location.href='{{route('product_manager.product.stock-limit-list',['in_house', ''])}}/?sort_oqrderQty='+this.value">
                                    <option
...
@push('script')
    <script>
        function update_quantity(val) {
            $.get({
                url: '{{url('/')}}/product_manager/product/get-variations?id=' + val,
                dataType: 'json',
