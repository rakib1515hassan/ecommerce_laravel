                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            ...
                            <div class="col-lg-4">
                                <a href="{{route('product_manager.product.add-new')}}"
                            ...
                            <table id="datatable"
                                ...
                                @foreach($products as $k=>$p)
                                    <tr>
                                        ...
                                        <td><a href="{{route('product_manager.product.view',[$p['id']])}}">
                                                {{$p['name']}}
                                            </a></td>
                                        <td>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm"
                                               href="{{route('product_manager.product.edit',[$p['id']])}}">
                                            ...
                                            <form action="{{route('product_manager.product.delete',[$p['id']])}}"
...
@push('script')
    ...
    <script>
        ...
        $(document).on('change', '.status', function () {
            ...
            $.ajax({
                url: "{{route('product_manager.product.status-update')}}",
                method: 'POST',
                data: {
                    id: id,
                    status: status
