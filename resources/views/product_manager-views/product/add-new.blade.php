    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{ route('product_manager.product.list') }}">{{ translate('Product') }}</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="product-form" action="{{ route('product_manager.product.add-new') }}" method="post"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select
                                            class="js-example-basic-multiple js-states js-example-responsive form-control"
                                            name="product_manager_id" disabled
                                            required>
                                            <option>
                                                ---{{translate('Select')}}---
                                            </option>
                                            @foreach($product_managers as $product_manager)
                                                <option
                                                    value="{{$product_manager->id}}" {{$product_manager->id == auth('product_manager')->id() ? 'selected':''}}>
    ...
    <script>
        function check() {
            Swal.fire({
                ...
                $.post({
                    url: '{{ route('product_manager.product.add-new') }}',
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function (data) {
