                ...
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-4 pt-2">
                        ...
                        <div class="flex-start">
                            ...
                            <span class="mx-1">{{\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($product['unit_price']))}}</span>
                        </div>
                        <div class="flex-start">
                        ...
                        <div class="flex-start">
                            ...
                            <span class="mx-1">{{ $product->discount_type=='flat'?\App\Services\BackEndHelper::set_symbol(\App\Services\BackEndHelper::usd_to_currency($product->discount)): $product->discount.''.'%'}}</span>
                        </div>
                        <div class="flex-start">
