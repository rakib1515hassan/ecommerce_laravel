...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a
                        href="{{route('product_manager.dashboard.index')}}">{{translate('Dashboard')}}</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{route('product_manager.product.update',$product->id)}}"
                      method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <select
                                            ...
                                            name="category_id"
                                            id="category_id"
                                            onchange="getRequest('{{url('/')}}/product_manager/product/get-categories?parent_id='+this.value,'sub-category-select','select')">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select
                                            ...
                                            onchange="getRequest('{{url('/')}}/product_manager/product/get-categories?parent_id='+this.value,'sub-sub-category-select','select')">
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select
                                            class="js-example-basic-multiple js-states js-example-responsive form-control"
                                            name="product_manager_id" required>
                                            <option>
                                                ---{{translate('Select')}}---
                                            </option>
                                            @foreach($product_managers as $product_manager)
                                                <option
                                                    value="{{$product_manager->id}}" {{$product_manager->id==$product['product_manager_id']?'selected':''}}>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="reseller_amount" class="form-control"
                                               ...
                                               value="{{ old('reseller_amount', $product['reseller_amount']) }}"
                                               required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-2 mb-2">
                                        <div class="customer_choice_options" id="customer_choice_options">
                                            @include('product_manager-views.product.partials._choices',['choice_no'=>json_decode($product['attributes']),'choice_options'=>json_decode($product['choice_options'],true)])
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" min="0" step="0.01"
                                               ...
                                               value={{\App\Services\BackEndHelper::usd_to_currency($product->unit_price)}} required>
                                    </div>
                                    <div class="col-md-6">
                                        <label
                                        ...
                                        <input type="number" min="0" step="0.01"
                                               ...
                                               value={{ \App\Services\BackEndHelper::usd_to_currency($product->purchase_price) }} required>
                                    </div>
                                </div>
                                <div class="row pt-4">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" min="0"
                                               value={{ $product->discount_type=='flat'?\App\Services\BackEndHelper::usd_to_currency($product->discount): $product->discount}} step="0.01"
                                ...
                                <div class="sku_combination pt-4" id="sku_combination">
                                    @include('product_manager-views.product.partials._edit_sku_combinations',['combinations'=>json_decode($product['variation'],true)])
                                </div>
                                <div class="row">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <img style="width: 100%" height="auto"
                                                                 ...
                                                                 alt="Product image">
                                                            <a href="{{route('product_manager.product.remove-image',['id'=>$product['id'],'name'=>$photo])}}"
                            ...
                            <div class="col-md-12" style="padding-top: 20px">
                                @if($product['request_status'] == 2)
                                    <button type="button" onclick="check()"
                                            class="btn btn-primary">{{ translate('resubmit') }}</button>
                                @else
                                    <button type="button" onclick="check()"
...
@push('script')
    ...
    <script>
        ...
        function update_sku() {
            ...
            $.ajax({
                type: "POST",
                url: '{{route('product_manager.product.sku-combination')}}',
        ...
        $(document).ready(function () {
            ...
            getRequest('{{url('/')}}/product_manager/product/get-categories?parent_id=' + category + '&sub_category=' + sub_category, 'sub-category-select', 'select');
            getRequest('{{url('/')}}/product_manager/product/get-categories?parent_id=' + sub_category + '&sub_category=' + sub_sub_category, 'sub-sub-category-select', 'select');
    ...
    <script>
        function check() {
            ...
            $.post({
                url: '{{route('product_manager.product.update',$product->id)}}',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
