...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{route('product_manager.dashboard.index')}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{route('product_manager.profile.update',[$data->id])}}" method="post"
                      enctype="multipart/form-data" id="product_manager-profile-form">
                    @csrf
                    <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 class="avatar-img"
                                 src="{{asset('storage/product_manager')}}/{{$data->image}}"
                                 alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button"
                                        onclick="{{env('APP_MODE')!='dev'?"form_alert('product_manager-profile-form','Want to update product_manager info ?')":"call_demo()"}}"
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changePasswordForm" action="{{route('product_manager.profile.settings-password')}}"
                              method="post"
