...
@section('title', translate('Bank Info View'))
@push('css_or_js')
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{translate('product_manager')}}</li>
                <li class="breadcrumb-item">{{translate('my_bank_info')}}</li>
            </ol>
        </nav>
                    ...
                    <div class="card-body">
                        <div class="col-md-8 mt-4">
                            ...
                            <a class="btn btn-primary"
                               href="{{route('product_manager.profile.bankInfo',[$data->id])}}">{{translate('Edit')}}</a>
                        </div>
                    </div>
                </div>
            </div>
